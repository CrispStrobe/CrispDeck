...
- 872 tests across 71 test files
...
```bash
npm test              # 872 frontend tests (unit + integration)
...
- **CI** (`ci.yml`): 872 frontend tests + frontend build + Rust check on Linux/macOS/Windows — every push and PR
...
- 872 frontend tests across 71 test files + 15 Rust tests
