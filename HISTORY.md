...
Work that is finished, moved out of PLAN.md so the plan is a plan rather than
an archive. Split on 2026-09-21, when 136 of 144 entries were marked done and the
file had grown to 1,777 lines.

Each entry keeps the phase it belonged to and what it actually said, including
the parts that record a mistake or a decision taken and why — those are the
parts worth keeping. PLAN.md now holds only open work and the reference
material that is still true.
