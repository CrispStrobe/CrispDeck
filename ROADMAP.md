...
- [x] Multi-column Deck view (TweetDeck-style)
- [x] Profile pages (view any user, follow/unfollow, posts/replies/media tabs)
- [x] Notifications (unified Bluesky + Mastodon)
- [x] Direct messages (Bluesky chat + Mastodon conversations)
- [x] Lists & Feeds (Mastodon lists + Bluesky custom feeds)
- [x] Bluesky Starter Packs (browse, search)
- [x] Trending (Mastodon tags, links, posts)
