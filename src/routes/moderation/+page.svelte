          ...
          <div class="p-4 bg-[var(--color-surface)] rounded-lg border border-[var(--color-border)]">
            <div class="flex items-start justify-between">
              <div class="flex items-center gap-3">
                {#if list.avatar}
                  <img loading="lazy" decoding="async" src={list.avatar} alt="" class="w-10 h-10 rounded-lg" />
                {/if}
                <div>
        ...
        {#each items as item}
          <div class="flex items-center justify-between p-3 bg-[var(--color-surface)] rounded-lg border border-[var(--color-border)]">
            <div class="flex items-center gap-3">
              ...
              {#if item.avatar}
                <img loading="lazy" decoding="async" src={item.avatar} alt="" class="w-8 h-8 rounded-full" />
              {:else}
