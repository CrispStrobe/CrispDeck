<script lang="ts">
  ...
  import MutedWordsSection from '$lib/components/settings/MutedWordsSection.svelte';
  import TagGroupsSection from '$lib/components/settings/TagGroupsSection.svelte';
  import RssFeedsSection from '$lib/components/settings/RssFeedsSection.svelte';</script>
